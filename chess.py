...
class King:
    ...
    def available_moves(self, opposite_valid_moves):
        ...
        if self.col-1 >= 0 and ((chess_board[self.row][self.col-1] is None or chess_board[self.row][self.col-1].color != self.color)
                                and (self.col-1, self.row) not in opposite_valid_moves):
    ...
    def chaseling(self, opposite_valid_moves, direction):
        ...
        if direction == 'left':
            ...
            if (self.col - 2 >= 0 and (chess_board[self.row][self.col - 2] is None and
               (self.col - 1, self.row) not in opposite_valid_moves)):
...
def update_locations(co, ro, obj):
    ...
    if che.check:
        ...
        if obj.name == 'King':
            # print("Yes")
            if(co == 1 and ro == 0 and chess_board[0][0].name == 'Rook') or (co == 1 and ro == 7 and chess_board[7][0].name == 'Rook'):
            ...
            elif(co==5 and ro == 0 and chess_board[0][7].name == 'Rook') or (co == 5 and ro == 7 and chess_board[7][7].name == 'Rook'):
